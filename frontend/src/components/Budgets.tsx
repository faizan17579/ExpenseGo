        ...
        <div className="max-w-3xl mx-auto">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-xl sm:text-2xl font-bold text-slate-800 dark:text-white">My Budgets</h1>
            </div>
            <Link
              to="/budgets/add"
          ...
          {loading ? (
            ...
            <div className="text-center py-8 sm:py-12">
              <Wallet className="h-10 w-10 sm:h-12 sm:w-12 text-slate-400 mx-auto mb-3 sm:mb-4" />
              <h3 className="text-base sm:text-lg font-medium text-slate-900 dark:text-white">No budgets yet</h3>
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-3 sm:mb-4">
                    <div>
                      ...
                      <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400">
                        {formatDate(budget.createdAt)} - {formatDate(budget.expiryDate)}
                      </p>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="w-full bg-slate-200 dark:bg-slate-700 rounded-full h-1.5 sm:h-2">
                      <div
                        ...
                        style={{ width: `${calculateProgress(budget.amount, budget.remaining)}%` }}
                      ></div>
                    </div>
                  </div>
                </div>
